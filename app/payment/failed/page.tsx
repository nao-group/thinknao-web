      ...
      <Box className="payment-success-card payment-failed-card" style={{ width: "100%", maxWidth: 540 }}>
        ...
        <Stack className="payment-success-body" gap={0} p={rem(32)}>
          <Box style={{ textAlign: "center", marginBottom: rem(24) }}>
            ...
            <Text className="checkout-heading" fw={800} fz={27} style={{ color: "var(--ck-ink)" }}>Let&apos;s get you back on track</Text>
          </Box>

          <Text size="sm" ta="center" style={{ color: "var(--ck-muted)", lineHeight: 1.7, marginBottom: rem(28) }}>
          ...
          <Box className="payment-success-info payment-failed-info" style={{ borderRadius: rem(12), padding: rem(16), marginBottom: rem(28), textAlign: "center" }}>
            ...
            <Text size="xs" style={{ color: "var(--ck-muted)" }}>Check your payment details or choose another method on the checkout page.</Text>
          </Box>
          ...
          <Button component="a" href={`https://wa.me/${process.env.NEXT_PUBLIC_WA_NUMBER ?? "6285284229998"}?text=${encodeURIComponent("Hi ThinkNao! My payment failed and I need help completing my subscription.")}`} target="_blank" rel="noopener noreferrer" variant="outline" fullWidth size="sm" leftSection={<IconBrandWhatsapp size={16} />} classNames={{ root: "checkout-outline-btn" }} styles={{ root: { borderColor: "rgba(15,23,42,0.16)", color: "var(--ck-ink)", borderRadius: rem(10), fontWeight: 500 } }}>
